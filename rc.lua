...
beautiful.init("/home/casper/.config/awesome/themes/default/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "Terminal", "Browser", 3, 4, 5, 6, 7, 8, "Rhythmbox"}, s, layouts[1])
end
-- }}}
...
for s = 1, screen.count() do
    ...
    -- Create Gizmoguy's acpi battery widget
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey, "Control" }, "Return", function() awful.util.spawn("gnome-terminal \-\-window-with-profile=bash_greenonblack") end),
    ...
    -- However, if the channel you're using is "Speaker" or "Headphone"
    ...
    awful.key({ modkey },"l",function () awful.util.spawn("xtrlock -b") end)
